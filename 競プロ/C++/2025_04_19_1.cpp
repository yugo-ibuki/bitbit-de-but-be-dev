 ...
 * あるタイミングで一斉に報告書の伝達を開始したときに、トップの組織の元に全ての組織の報告書が揃う時刻
 * （伝達を始めてから何分後か）を求めてください。
 * なお、各組織の報告書は既に準備されているため、報告書の伝達以外の時間はかからないこととします。
 * 
 * 解法のポイント:
 * 1. 各組織を頂点、親子関係を辺とする木構造を考える
 * 2. 各組織は子組織からの報告書が全て揃ってから親組織に送るため、
 *    ある組織の報告書が親組織に届く時間は「子組織からの報告書が全て揃う時間 + 1分」
 * 3. 葉ノード（子を持たない組織）は即座に報告書を親に送るため、親に届くまで1分
 * 4. 深さ優先探索(DFS)を使って、各組織の報告書が揃う時間を計算する
 */

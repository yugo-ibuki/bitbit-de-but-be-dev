/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e58ba47b022584d9bdbd1e7d3c21332b)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	JOB_QUEUE: Queue;
	AUDIT_QUEUE: Queue;
	JOB_WORKFLOW: Workflow<Parameters<import("./src/index").JobWorkflow['run']>[0]['payload']>;
}
